...
export function llenarTienda(){
    ...
    let productos=[
        ...
        {nombre:"La era del Traje Negro",precio:17000,foto:"../img/3.png",descripcion:"spiderman traje negro"},
        ...
        {nombre:"Ley y Orden",precio:130000,foto:"../img/7.jpg",descripcion:"de spiderman ley y el orden"},
        {nombre:"La Identidad del Duende",precio:160000,foto:"../img/8.jpg",descripcion:"funkos spiderman"},
        {nombre:"El Regreso del Ladron",precio:115000,foto:"../img/9.jpg",descripcion:"spiderman la identidad del duende"},
        {nombre:"La Muerte de Gwen Stacy",precio:110000,foto:"../img/10.jpg",descripcion:"la muerte de gwen staicy"}
    ]
